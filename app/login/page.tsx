...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        // "select_account" forces the Google popup just like enterprise apps
        queryParams: {
          access_type: 'offline',
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="group">
              <div className="flex justify-between items-center mb-2">
                ...
                <Button type="button" variant="ghost" size="sm" className="text-[10px] font-bold text-blue-600 hover:underline uppercase tracking-tighter">Lost Access?</Button>
              </div>
              <div className="relative">
